...
public class TLCPContext {
    ...
    private Iterable<String> ciphers = Arrays.asList("TLCP_ECC_SM4_CBC_SM3");
    private CipherSuiteFilter cipherFilter = new AllAllowedCipherSuiteFilter();
    private ApplicationProtocolConfig apn;
    private ClientAuth clientAuth = ClientAuth.NONE;
    private String[] protocols = new String[] {"TLCPv1.1"};

    private final JdkSslContext jdkSslContext;


    public TLCPContext() throws Exception {
        this.apn = new ApplicationProtocolConfig(
        ...
        this.jdkSslContext = new JdkSslContext(this.sslContext,
                            this.isClient,
                            this.ciphers,
                            this.cipherFilter,
                            this.apn,
    ...
    public TLCPContext(boolean isClient) throws Exception {
        this.apn = new ApplicationProtocolConfig(
                ApplicationProtocolConfig.Protocol.ALPN,
                ApplicationProtocolConfig.SelectorFailureBehavior.FATAL_ALERT,
                ApplicationProtocolConfig.SelectedListenerFailureBehavior.FATAL_ALERT,
    ...
    public SslHandler newHandler(ByteBufAllocator alloc){
        return this.jdkSslContext.newHandler(alloc);
    }

    private class AllAllowedCipherSuiteFilter implements CipherSuiteFilter {
    ...
    private KeyStore createTrustStore(String caStr, String caId)
            throws Exception {
